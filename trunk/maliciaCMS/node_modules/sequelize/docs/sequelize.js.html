...
<div class="row">
    ...
    <div class="nine columns">
        <div class="comment">
            ...
            <h1 id="Sequelize">Sequelize</h1><h5 class="subheader">Sequelize()</h5>

            <div class="description"><p>Main constructor of the project.</p>
...
<pre><code>Params:
    ...
    mymodule.write('foo', { stream: process.stderr })
            ...
            </div><pre><code class="language-javascript">var Sequelize = function(database, username, password, options)
            {
            ...
            console.log('DEPRECATION WARNING: The logging-option should be either a function or false. Default:
            console.log')
            ...
            database: database,
            username: username,
            password: (( (["", null, false].indexOf(password) > -1) || (typeof password == 'undefined')) ? null :
            password),
        ...
        <div class="comment">
            <div class="label radius ctx-type">property</div>
            <h1 id="Utils">Utils</h1><h5 class="subheader">Sequelize.Utils</h5>

            <div class="description"><p>Reference to Utils</p></div>
            <div class="tags">
                <ul class="no-bullet"></ul>
            </div><pre><code class="language-javascript">Sequelize.Utils = Utils
