...
<div class="row">
    ...
    <div class="nine columns">
        <div class="comment">
            ...
            <h1 id="mysql">mysql</h1><h5 class="subheader">mysql</h5>

            <div class="description"></div>
            <div class="tags">
                <ul class="no-bullet"></ul>
            </div><pre><code class="language-javascript">var mysql = require("mysql")
            ...
            return (tableName1.toLowerCase() < tableName2.toLowerCase()) ? (tableName1 + tableName2) : (tableName2 +
            tableName1)
            },
            ...
            hash[prefix + key] = Utils._.isString(instance) ? instance : Utils._.isObject(instance) ? instance[elem.key
            || elem] : null
            })
            } else {
            hash[prefix + identifier] = Utils._.isString(instance) ? instance : Utils._.isObject(instance) ? instance.id
            : null
            }
            ...
            Utils.Lingo = require("lingo")</code></pre>
        </div>
    </div>
</div>
<style>/**
