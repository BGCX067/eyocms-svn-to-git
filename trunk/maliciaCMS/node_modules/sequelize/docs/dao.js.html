...
<div class="row">
    ...
    <div class="nine columns">
        <div class="comment">
            ...
            <h1 id="validate">validate</h1><h5 class="subheader">DAO.prototype.validate()</h5>

            <div class="description"><p>Validate this dao's attribute values according to validation rules set in the
                dao definition.</p></div>
            <div class="tags">
                <ul class="no-bullet">
                    <li><strong>@return: </strong><span class="types"> {null} </span><span class="description">if and only if validation successful; otherwise an object containing { field name : [error msgs] } entries.</span>
                    </li>
                </ul>
            </div><pre><code class="language-javascript">DAO.prototype.validate = function() {
            var self = this
            var failures = {}
        ...
        <div class="comment">
            <div class="description"><p>Add the instance methods to DAO</p></div>
            <div class="tags">
                <ul class="no-bullet"></ul>
            </div><pre><code class="language-javascript">Utils._.extend(DAO.prototype, Mixin.prototype)
