...
describe('Migrator', function () {
    ...
    describe('migrations', function () {
        beforeEach(function () {
            ...
            Helpers.async(function (done) {
                migrator.migrate().success(done).error(function (err) {
                    console.log(err)
                })
            })
        })
            ...
            it("executes migration #20111117063700 and correctly creates the table", function () {
                Helpers.async(function (done) {
                    sequelize.getQueryInterface().showAllTables().success(function (tableNames) {
                        tableNames = tableNames.filter(function (e) {
                            return e != 'SequelizeMeta'
                        })
            ...
            it("executes migration #20111117063700 and correctly adds isBetaMember", function () {
                Helpers.async(function (done) {
                    sequelize.getQueryInterface().describeTable('Person').success(function (data) {
                        var beta = data.filter(function (d) {
                            return d.Field == 'isBetaMember'
                        })
            ...
            it('adds a column to the user table', function () {
                ...
                Helpers.async(function (done) {
                    sequelize.getQueryInterface().describeTable('User').success(function (data) {
                        var signature = data.filter(function (hash) {
                                return hash.Field == 'signature'
                            })[0]
                            , isAdmin = data.filter(function (hash) {
                                return hash.Field == 'isAdmin'
                            })[0]
                            , shopId = data.filter(function (hash) {
                                return hash.Field == 'shopId'
                            })[0]
            ...
            Helpers.async(function (done) {
                sequelize.getQueryInterface().describeTable('User').success(function (data) {
                    var signature = data.filter(function (hash) {
                        ...
                        , sig = data.filter(function (hash) {
                            return hash.Field == 'sig'
                        })[0]
