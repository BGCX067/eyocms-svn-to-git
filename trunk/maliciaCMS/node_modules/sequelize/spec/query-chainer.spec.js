...
describe("[" + dialect.toUpperCase() + "] QueryChainer", function () {
    ...
    describe('run', function () {
        it('finishes when all emitters are finished', function (done) {
            var emitter1 = new CustomEventEmitter(function (e) {
                e.emit('success')
            })
            var emitter2 = new CustomEventEmitter(function (e) {
                e.emit('success')
            })
        ...
        it("returns the result of the passed emitters in the order of the occurrence of adding the emitters", function (done) {
            var emitter1 = new CustomEventEmitter(function (e) {
                ...
                , emitter2 = new CustomEventEmitter(function (e) {
                    e.emit('success', 2)
                })
                , emitter3 = new CustomEventEmitter(function (e) {
                    e.emit('success', 3)
                })
