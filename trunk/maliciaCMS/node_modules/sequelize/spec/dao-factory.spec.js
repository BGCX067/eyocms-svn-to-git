    ...
    describe('constructor', function () {
        ...
        it("attaches class and instance methods", function () {
            var User = this.sequelize.define('UserWithClassAndInstanceMethods', {}, {
                classMethods:{ doSmth:function () {
                    return 1
                } },
                instanceMethods:{ makeItSo:function () {
                    return 2
                }}
            })
                                ...
                                user1.setTasks([task1, task2]).success(function () {
                                    this.Task.find({
                                        ...
                                        include:[ 'UserWithName' ]
                                            ...
                                            expect(
                                                task.userWithNames.map(function (u) {
                                                    return u.id
                                                })
                                            ).toEqual(
                                                [ user1.id ]
                                ...
                                user1.setTasks([task1, task2]).success(function () {
                                    this.Task.findAll({
                                        ...
                                        include:[ 'UserWithName' ]
                                            ...
                                            expect(
                                                tasks[0].userWithNames.map(function (u) {
                                                    return u.id
                                                })
                                            ).toEqual(
                                                [ user1.id ]
