...
module.exports = (function () {
    var QueryGenerator = {
        ...
        selectQuery:function (tableName, options) {
            ...
            options = options || {}
            options.table = table = Array.isArray(tableName) ? tableName.map(function (tbl) {
                return Utils.addTicks(tbl)
            }).join(", ") : Utils.addTicks(tableName)
        ...
        insertQuery:function (tableName, attrValueHash) {
            ...
            var replacements = {
                table:Utils.addTicks(tableName),
                attributes:Utils._.keys(attrValueHash).map(function (attr) {
